...
!function(a, b) {
    ...
    r.extend({
        attr: function(a, b, c) {
            ...
            if (3 !== f && 8 !== f && 2 !== f)
                return "undefined" == typeof a.getAttribute ? r.prop(a, b, c) : (1 === f && r.isXMLDoc(a) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? Ya : void 0)),
    ...
    r.fn.extend({
        ...
        hasClass: function(a) {
            ...
            b = " " + a + " ";
            while (c = this[d++])
                if (1 === c.nodeType && (" " + ab(bb(c)) + " ").indexOf(b) > -1)
                    return !0;
            return !1
        }
    });
    ...
    r.extend(r.event, {
        trigger: function(b, c, e, f) {
            ...
            if (h = i = e = e || d,
            3 !== e.nodeType && 8 !== e.nodeType && !db.test(p + r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."),
            p = q.shift(),
            q.sort()),
            k = p.indexOf(":") < 0 && "on" + p,
            ...
            f || !n.trigger || n.trigger.apply(e, c) !== !1)) {
                if (!f && !n.noBubble && !r.isWindow(e)) {
                    ...
                    db.test(j + p) || (h = h.parentNode); h; h = h.parentNode)
                        o.push(h),
                        i = h;
